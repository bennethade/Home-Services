...
class EditSproviderProfileComponenet extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.sprovider.edit-sprovider-profile-componenet',['scategories'=>$scategories])->layout('layouts.base');
    }
}
