...
<head>
    <meta charset="utf-8">
    <title>Workenzo - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li>Call To Book a Service Provider</a></li>
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> +234-803 696 9183</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    contact@workenzo.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+911234567890"><i class="fa fa-phone"></i>
                                    +234-803 696 9183</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Abuja, Nigeria</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Abuja,
                                    Nigeria</a></li>
                        </ul>
                    </div>
                </div>
                            ...
                            @if(Auth::user()->utype==='ADM')
                                <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('admin.all_service_requests') }}">All Service Requests</a></li>
                                        <li><a href="{{ route('admin.service_providers') }}">All Service Providers</a></li>
                                        {{-- <li><a href="{{ route('admin.service_providers_list') }}">All Service Providers</a></li> --}}
                            ...
                            @elseif(Auth::user()->utype==='SVP')
                                <li class="login-form"> <a href="#" title="Register">My Account (Service Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('sprovider.all_services') }}">My Services</a></li>
                            ...
                            @else
                                <li class="login-form"> <a href="#" title="Register">My Account (Customer)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('customer.all_requests') }}">My requests</a></li>
                                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>                                    </ul>  
                                </li>
                            @endif
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> FCT Abuja, Nigeria</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">contact@workenzo.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+234 8036969183">+234 803 696 9183</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> FCT Abuja, Nigera</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">contact@workenzo.com</a>
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+234 8036969183">+234 803 696 9183</a>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="nav-footer">
                                ...
                                <li><a href="{{ route('home.terms_of_use') }}">Terms of Use</a></li>
                                <li><a href="{{ route('home.privacy_policy') }}">Privacy</a></li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2023 Workenzo. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>    
