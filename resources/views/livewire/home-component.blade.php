    ...
    <section class="content-central">
                    ...
                    <div class="col-md-12">
                        <ul id="sponsors" class="tooltip-hover">
                            @foreach ($scategories as $scategory)
                                <li data-toggle="tooltip" title="" data-original-title="{{ $scategory->names }}"> 
                                    <a href="{{ route('home.service_providers',['category_slug'=>$scategory->slug]) }}">
        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>Workenzo <span>Choice</span> of Services</h2>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{ route('home.service_details',['service_slug'=>$service->slug]) }}">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn"><a href="{{ route('home.service_details',['service_slug'=>$service->slug]) }}"
                                                class="btn btn-primary">View Service</a></div>
                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="services-lines-info">
                                <h2>WELCOME TO WORKENZO SYSTEM</h2>
                                <p class="lead">
                                    Where we match needed services to qualified workers.
                        ...
                        <div class="col-md-8">
                            <ul class="services-lines">
                                @foreach($featuredSCategories as $featuredSCategory)
                                <li>
                                    <a href="{{ route('home.service_providers',['category_slug'=>$featuredSCategory->slug]) }}">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/categories') }}/{{ $featuredSCategory->image }}"></i>
                                            <h5>{{ $featuredSCategory->name }}</h5>
                                        </div>
                                    </a>
                                </li>
                                @endforeach
        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="titles">
                        <h2>Home<span>Appliance</span>Services</h2>
                        <i class="fa fa-plane"></i>
                        <hr class="tall">
                    </div>
                </div>
