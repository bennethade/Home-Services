                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                    ...
                                    <a href="{{ route('home.service_details',['service_slug'=>$related_service->slug]) }}">
                                        <div class="img-hover">
                                            <img src="{{ asset('images/services/thumbnails') }}/{{ $related_service->thumbnail }}" alt="{{ $related_service->name }}"
                                                class="img-responsive">
                                        </div>
                                        <div class="info-gallery">
                                            ...
                                            <div class="content-btn"><a href="{{ route('home.service_details',['service_slug'=>$related_service->slug]) }}"
