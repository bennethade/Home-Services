                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form-horizontal" wire:submit.prevent="updateProfile">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="file" class="form-control-file" name="newimage" id="" wire:model="newimage">
                                                        @if($newimage)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea class="form-control" name="about" id="" cols="30" rows="10" wire:model="about"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="city" class="control-label col-md-3">City: </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="city" id="" wire:model="city">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="service_locations" id="" wire:model="service_locations">
                                                    </div>
                                                </div>
