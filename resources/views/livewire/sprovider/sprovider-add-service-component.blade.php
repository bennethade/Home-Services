                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('sprovider.all_services') }}" class="btn btn-info pull-right">My Services</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="createService">
                                        ...
                                        <div class="form-group">
                                            <label for="user_id" class="control-label col-sm-3">Provider ID</label>
                                            <div class="col-sm-9">

                                                <input type="text" class="form-control" name="user_id" wire:model="user_id" placeholder="{{ Auth::user()->id }}" value="{{ Auth::user()->id }}" disabled="disabled">
